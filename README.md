...
Foydalanuvchining Telegram user_idini aniqlaydi.

CHANNELS ro‘yxatidagi har bir kanal uchun:
...
Agar foydalanuvchi birorta ham kanalga obuna bo‘lmagan bo‘lsa:
...
async def check(user_id: int, kanal_id: int) -> int:
    try:
        ...
        return 0
3. Middleware'ni dispatcherga qo‘shing:
python
Copy
Edit
